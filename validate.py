...
def main():
    ...
    parser.add_argument("--gt_dataset_path", type=str, required=True, help="Path to ground truth vqa dataset")
    parser.add_argument("--pred_dataset_path", type=str, required=True, help="Path to prediction vqa dataset")
